...
<MetaTags title="registry-kit - Components for your registry" />

<header class="sticky top-0 z-40 flex justify-end px-4 py-2">
...
<main class="flex flex-col place-items-center px-4 pb-4">
